...
export const nsfwItems: PortfolioItem[] = [
  { type: 'image', color: 'from-red-200 to-rose-200', iconColor: 'text-red-600', icon: <ImageIcon />, mediaUrl: 'https://res.cloudinary.com/dnbdnjpd4/image/upload/v1781970122/photo_2026-06-20_12-38-13_no3ei0.jpg' },
];
