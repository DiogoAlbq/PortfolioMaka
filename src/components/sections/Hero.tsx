  ...
  return (
    <section id="home" className="relative pt-32 pb-12 px-6 min-h-[80vh] flex flex-col justify-center overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 px-4">
        ...
        >
          <a href="https://x.com/TheMakasan" target="_blank" rel="noopener noreferrer" title="Twitter/X" className={`p-3 border-2 rounded-xl transition-all shadow-sm hover:shadow-md backdrop-blur-sm flex items-center justify-center ${theme.socialBtn}`}>
          ...
          <a href="https://x.com/TheMakasanNSFW" target="_blank" rel="noopener noreferrer" title="Twitter NSFW" className={`p-3 border-2 rounded-xl transition-all shadow-sm hover:shadow-md backdrop-blur-sm relative overflow-hidden flex items-center justify-center ${theme.socialBtn}`}>
            <div className="absolute inset-x-0 bottom-0 top-0 opacity-10 bg-red-500 rounded-lg pointer-events-none"></div>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-red-500"><path d="M4 4l11.733 16h4.267l-11.733 -16z"/><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772"/></svg>
            <span className="sr-only">NSFW X/Twitter</span>
          </a>
          <a href="https://www.instagram.com/makasanart/?hl=pt" target="_blank" rel="noopener noreferrer" title="Instagram" className={`p-3 border-2 rounded-xl transition-all shadow-sm hover:shadow-md backdrop-blur-sm flex items-center justify-center ${theme.socialBtn}`}>
            <Instagram className="w-6 h-6" />
          </a>
          <a href="https://www.tiktok.com/@themakasan" target="_blank" rel="noopener noreferrer" title="TikTok" className={`p-3 border-2 rounded-xl transition-all shadow-sm hover:shadow-md backdrop-blur-sm flex items-center justify-center ${theme.socialBtn}`}>
          ...
          <a href="https://www.youtube.com/@TheMakasan" target="_blank" rel="noopener noreferrer" title="YouTube" className={`p-3 border-2 rounded-xl transition-all shadow-sm hover:shadow-md backdrop-blur-sm flex items-center justify-center ${theme.socialBtn}`}>
