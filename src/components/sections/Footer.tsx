  ...
  return (
    <footer className={`py-10 px-6 border-t font-medium text-center text-sm flex flex-col items-center gap-6 transition-colors duration-500 ${isDarkMode ? 'border-slate-800 text-slate-500' : 'border-white/50 text-slate-500'}`}>
      <div className="flex items-center justify-center gap-3">
        <a href="https://x.com/TheMakasan" target="_blank" rel="noopener noreferrer" title="Twitter/X" className={`p-2.5 border-2 rounded-xl transition-all flex items-center justify-center ${theme.footerIcon}`}>
        ...
        <a href="https://www.youtube.com/@TheMakasan" target="_blank" rel="noopener noreferrer" title="YouTube" className={`p-2.5 border-2 rounded-xl transition-all flex items-center justify-center ${theme.footerIcon}`}>
